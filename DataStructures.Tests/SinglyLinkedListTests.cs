...
public sealed class SinglyLinkedListTests : LinkedListsTests<SinglyLinkedListItem<int?>>
{
    ...
    protected override bool CheckTwoItemsListReferences(LinkedListBase<SinglyLinkedListItem<int?>, int?> list) => ReferenceEquals(list.First?.Next, list.Last) && list.Last?.Next is null;
